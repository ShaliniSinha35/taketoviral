          ...
          >
            <View style={{ paddingVertical: 8, borderRadius: 10, backgroundColor: "#fff",paddingHorizontal:0 }}>
              <View style={{ padding: 8, flexDirection: "column", alignItems: "center" }}>
                ...
                <MaskedView
        maskElement={<Text allowFontScaling={false} numberOfLines={2} style={{ letterSpacing: 1,textAlign:"center" }}>{item.name}</Text>}
      >
        <LinearGradient colors={['#FF1493', '#8A2BE2', '#FF1493', '#8A2BE2']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
        <Text allowFontScaling={false} numberOfLines={2} style={{ letterSpacing: 1,textAlign:"center",opacity:0 }}>Name: {item.name}</Text>
        </LinearGradient>
      </MaskedView>
